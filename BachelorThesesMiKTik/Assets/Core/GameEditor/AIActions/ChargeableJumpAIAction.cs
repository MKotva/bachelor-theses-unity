...
namespace Assets.Core.GameEditor.AIActions
{
    public class ChargeableJumpAIAction : AIActionBase
    {
        ...
        public ChargeableJumpAIAction(GameObject jumpingObject, float verticalMin = 1, float verticalMax = 1, float horizontalMin = 1, float horizontalMax = 1, float jumpTime = 1) : base(50)
        {
            ...
            jumpMaxTime = jumpTime;
        }


        public ChargeableJumpAIAction(GameObject jumpingObject, float jumpForce = 5, float moveSpeed = 2) : base(50)
        {
            performer = jumpingObject;
        ...
        public ChargeableJumpAIAction(GameObject jumpingObject, float defaultBounceForce, float jumpForce, float moveSpeed) : this(jumpingObject, jumpForce, moveSpeed)
        {
